    ...
    [1836], {
        5683: (t, e, i) => {
            ...
            function h(t) {
                let {
                    ...
                    isPresent: i,
                    anchorX: r
                } = t, o = (0, n.useId)(), a = (0, n.useRef)(null), h = (0, n.useRef)({
                    width: 0,
                    height: 0,
                    top: 0,
                    left: 0,
            ...
            let d = t => {
                let {
                    ...
                    mode: p,
                    anchorX: m
                } = t, f = (0, o.M)(c), v = (0, n.useId)(), g = (0, n.useCallback)(t => {
                ...
                return (0, n.useMemo)(() => {
                    ...
                    r || f.size || !l || l()
                }, [r]), "popLayout" === p && (e = (0, s.jsx)(h, {
                    isPresent: r,
                    anchorX: m,
                    children: e
                })), (0, s.jsx)(a.t.Provider, {
                    value: y,
                    children: e
                })
            };
            ...
            let g = t => {
                let {
                    ...
                    propagate: c = !1,
                    anchorX: g = "left"
                } = t, [y, x] = (0, p.xQ)(c), P = (0, n.useMemo)(() => f(e), [e]), w = c && !y ? [] : P.map(m), T = (0, n.useRef)(!0), b = (0, n.useRef)(P), S = (0, o.M)(() => new Map), [A, E] = (0, n.useState)(P), [M, V] = (0, n.useState)(P);
                (0, v.E)(() => {
                    T.current = !1, b.current = P;
                ...
                if (P !== A) {
                    ...
                    for (let e = 0; e < M.length; e++) {
                        let i = M[e],
                            s = m(i);
                        w.includes(s) || (t.splice(e, 0, i), C.push(i))
                    }
                    return "wait" === h && C.length && (t = C), V(f(t)), E(P), null
                }
                let {
                    forceRender: D
                } = (0, n.useContext)(r.L);
                    ...
                    children: M.map(t => {
                        ...
                        return (0, s.jsx)(d, {
                            ...
                            onExitComplete: n ? void 0 : () => {
                                ...
                                S.forEach(e => {
                                    e || (t = !1)
                                }), t && (null == D || D(), V(b.current), c && (null == x || x()), l && l())
                            },
                            anchorX: g,
                            children: t
                        }, e)
        ...
        698: (t, e, i) => {
            ...
            let L = t => 1e3 * t,
                ...
                O = new Set(B),
                I = new Set(["width", "height", "top", "left", "right", "bottom", ...B]),
                U = t => Array.isArray(t),
                $ = t => !!(t && "object" == typeof t && t.mix && t.toValue),
                N = t => U(t) ? t[t.length - 1] || 0 : t,
                W = {
                    skipAnimations: !1,
                    useManualTiming: !1
                },
                z = ["read", "resolveKeyframes", "update", "preRender", "render", "postRender"],
                H = {
                    value: null,
            ...
            function Y(t, e) {
                let i = !1,
                    ...
                    r = () => i = !0,
                    o = z.reduce((t, i) => (t[i] = function(t, e) {
                        let i = new Set,
                            s = new Set,
                            n = !1,
                            r = !1,
                        ...
                        let h = {
                            ...
                            process: t => {
                                ...
                                n = !0, [i, s] = [s, i], i.forEach(u), e && H.value && H.value.frameloop[e].push(l), l = 0, i.clear(), n = !1, r && (r = !1, h.process(t))
                            }
                        };
                        return h
                    }(r, e ? i : void 0), t), {}),
                    ...
                    p = () => {
                        ...
                        i = !1, W.useManualTiming || (n.delta = s ? 1e3 / 60 : Math.max(Math.min(r - n.timestamp, 40), 1)), n.timestamp = r, n.isProcessing = !0, a.process(n), l.process(n), u.process(n), h.process(n), d.process(n), c.process(n), n.isProcessing = !1, i && e && (s = !1, t(p))
                    },
                    m = () => {
            ...
            let {
                ...
                state: q,
                steps: G
            } = Y("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : F, !0);

            function _() {
                s = void 0
            }
            let Z = {
                now: () => (void 0 === s && Z.set(q.isProcessing || W.useManualTiming ? q.timestamp : performance.now()), s),
                set: t => {
                    s = t, queueMicrotask(_)
                }
            };
            ...
            class tt {
                ...
                add(t) {
                    return Q(this.subscriptions, t), () => J(this.subscriptions, t)
                }
                notify(t, e, i) {
            ...
            class ts {
                ...
                setCurrent(t) {
                    this.current = t, this.updatedAt = Z.now(), null === this.canTrackVelocity && void 0 !== t && (this.canTrackVelocity = te(this.current))
                }
            ...
            let tc = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
                ...
                tC = (t, e) => i => !!("string" == typeof i && tV.test(i) && i.startsWith(t) || e && null != i && Object.prototype.hasOwnProperty.call(i, e)),
                tD = (t, e, i) => s => {
                ...
                tL = {
                    ...
                    transform: ({
                        ...
                        blue: i,
                        alpha: s = 1
                    }) => "rgba(" + tk.transform(t) + ", " + tk.transform(e) + ", " + tk.transform(i) + ", " + tE(tS.transform(s)) + ")"
                },
                tj = {
                    test: tC("#"),
                    parse: function(t) {
                ...
                tW = {
                    ...
                    transform: ({
                        ...
                        lightness: i,
                        alpha: s = 1
                    }) => "hsla(" + Math.round(t) + ", " + tO.transform(tE(e)) + ", " + tO.transform(tE(i)) + ", " + tE(tS.transform(s)) + ")"
                },
                tz = {
                    test: t => tL.test(t) || tj.test(t) || tW.test(t),
                    parse: t => tL.test(t) ? tL.parse(t) : tW.test(t) ? tW.parse(t) : tj.parse(t),
                    transform: t => "string" == typeof t ? t : t.hasOwnProperty("red") ? tL.transform(t) : tW.transform(t)
                },
                tH = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu,
                tY = "number",
                tX = "color",
            ...
            function tq(t) {
                let e = t.toString(),
                    ...
                    n = [],
                    r = 0,
                    o = e.replace(tK, t => (tz.test(t) ? (s.color.push(r), n.push(tX), i.push(tz.parse(t))) : t.startsWith("var(") ? (s.var.push(r), n.push("var"), i.push(t)) : (s.number.push(r), n.push(tY), i.push(parseFloat(t))), ++r, "${}")).split("${}");
                return {
                    values: i,
                    split: o,
                    indexes: s,
            ...
            function t_(t) {
                ...
                return t => {
                    ...
                    for (let r = 0; r < s; r++)
                        if (n += e[r], void 0 !== t[r]) {
                            let e = i[r];
                            e === tY ? n += tE(t[r]) : e === tX ? n += tz.transform(t[r]) : n += t[r]
                        }
                    return n
                }
            }
            let tZ = t => "number" == typeof t ? 0 : t,
                tQ = {
                    test: function(t) {
                        var e, i;
                        return isNaN(t) && "string" == typeof t && ((null === (e = t.match(tM)) || void 0 === e ? void 0 : e.length) || 0) + ((null === (i = t.match(tH)) || void 0 === i ? void 0 : i.length) || 0) > 0
                    },
                    parse: tG,
                    createTransformer: t_,
                    getAnimatableNone: function(t) {
                        let e = tG(t);
                        return t_(t)(e.map(tZ))
                    }
                },
            ...
            function t4(t, e) {
                let i = t6(t);
                return i !== t5 && (i = tQ), i.getAnimatableNone ? i.getAnimatableNone(e) : void 0
            }
            ...
            function el() {
                ...
                ea = !1, eo = !1, er.forEach(t => t.complete()), er.clear()
            }
            ...
            class eh {
                ...
                scheduleResolve() {
                    this.isScheduled = !0, this.isAsync ? (er.add(this), eo || (eo = !0, X.read(eu), X.resolveKeyframes(el))) : (this.readKeyframes(), this.complete())
                }
                readKeyframes() {
                    let {
            ...
            class ew extends eh {
                    ...
                    for (let i = 0; i < t.length; i++) {
                        ...
                        if ("string" == typeof s && ef(s = s.trim())) {
                            let n = function t(e, i, s = 1) {
                                F(s <= 4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
                                let [n, r] = function(t) {
                                    let e = eg.exec(t);
                                    if (!e) return [, ];
                                    let [, i, s, n] = e;
                ...
                resolveNoneKeyframes() {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        var s;
                        ("number" == typeof(s = t[e]) ? 0 === s : null === s || "none" === s || "0" === s || tw(s)) && i.push(e)
                    }
                    i.length && function(t, e, i) {
                        let s, n = 0;
                        for (; n < t.length && !s;) {
                            let e = t[n];
                            "string" == typeof e && !t7.has(e) && tq(e).values.length && (s = t[n]), n++
                        }
                        if (s && i)
                            for (let n of e) t[n] = t4(i, s)
                    }(t, i, e)
                }
                measureInitialState() {
                    let {
                    ...
                    "height" === i && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = en[i](t.measureViewportBox(), window.getComputedStyle(t.current)), e[0] = this.measuredOrigin;
                    let s = e[e.length - 1];
                ...
                measureEndState() {
                    ...
                    let r = s.length - 1,
                        o = s[r];
                    s[r] = en[i](e.measureViewportBox(), window.getComputedStyle(e.current)), null !== o && void 0 === this.finalKeyframe && (this.finalKeyframe = o), (null === (t = this.removedTransforms) || void 0 === t ? void 0 : t.length) && this.removedTransforms.forEach(([t, i]) => {
                        e.getValue(t).set(i)
                    }), this.resolveNoneKeyframes()
                }
            }
            let eT = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (tQ.test(t) || "0" === t) && !t.startsWith("url(")),
                eb = t => null !== t;
            ...
            class eA {
                ...
                get resolved() {
                    return this._resolved || this.hasAttemptedResolve || (eu(), el()), this._resolved
                }
                onKeyframesResolved(t, e) {
                    ...
                    if (!l && ! function(t, e, i, s) {
                            ...
                            let r = t[t.length - 1],
                                o = eT(n, e),
                                a = eT(r, e);
                            return F(o === a, `You are trying to animate ${e} from "${n}" to "${r}". ${n} is not an animatable value - to enable this animation set ${n} to a value animatable to ${r} via the \`style\` property.`), !!o && !!a && (function(t) {
                                let e = t[0];
                ...
                return e === tW && (i = function({
                    ...
                    if (e /= 100) {
                        let s = i < .5 ? i * (1 + e) : i + e - i * e,
                            a = 2 * i - s;
                        n = eV(a, s, t + 1 / 3), r = eV(a, s, t), o = eV(a, s, t - 1 / 3)
                    } else n = r = o = i;
                    return {
            ...
            let ej = (t, e) => {
                    ...
                    return t => (n.red = eD(i.red, s.red, t), n.green = eD(i.green, s.green, t), n.blue = eD(i.blue, s.blue, t), n.alpha = eM(i.alpha, s.alpha, t), tL.transform(n))
                },
                eF = (t, e) => i => e(t(i)),
                eB = (...t) => t.reduce(eF),
            ...
            function eU(t) {
                return "number" == typeof t ? eI : "string" == typeof t ? ef(t) ? eC : tz.test(t) ? ej : eW : Array.isArray(t) ? e$ : "object" == typeof t ? tz.test(t) ? ej : eN : eC
            }
            ...
            let eW = (t, e) => {
                ...
                return s.indexes.var.length === n.indexes.var.length && s.indexes.color.length === n.indexes.color.length && s.indexes.number.length >= n.indexes.number.length ? eO.has(t) && !n.values.length || eO.has(e) && !s.values.length ? function(t, e) {
                    ...
                    return s
                }(s, n), n.values), i) : (F(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), eC(t, e))
            };

            function ez(t, e, i) {
                return "number" == typeof t && "number" == typeof e && "number" == typeof i ? eM(t, e, i) : eU(t)(t, e)
            }
            ...
            function e_(t = eY.visualDuration, e = eY.bounce) {
                let i;
                let s = "object" != typeof t ? {
                    ...
                    },
                    {
                        ...
                        if (!eG(t, eq) && eG(t, eK)) {
                            if (t.visualDuration) {
                                ...
                                let i = function({
                                    duration: t = eY.duration,
                                    bounce: e = eY.bounce,
                                    velocity: i = eY.velocity,
                                    mass: s = eY.mass
                                }) {
                                    let n, r;
                                    F(t <= L(eY.maxDuration), "Spring duration must be 10 seconds or less");
                                    let o = 1 - e;
                                    o = tT(eY.minDamping, eY.maxDamping, o), t = tT(eY.minDuration, eY.maxDuration, j(t)), o < 1 ? (n = e => {
                                        let s = e * o,
                                            n = s * t;
                                        return .001 - (s - i) / eX(e, o) * Math.exp(-n)
                                    }, r = e => {
                                        let s = e * o * t,
                    ...
                    P = j(Math.sqrt(u / d)),
                    w = 5 > Math.abs(y);
                if (n || (n = w ? eY.restSpeed.granular : eY.restSpeed.default), r || (r = w ? eY.restDelta.granular : eY.restDelta.default), g < 1) {
                    let t = eX(P, g);
                    i = e => a - Math.exp(-g * P * e) * ((v + g * P * y) / t * Math.sin(t * e) + y * Math.cos(t * e))
                } else if (1 === g) i = t => a - Math.exp(-P * t) * (y + (v + P * y) * t);
                else {
                    let t = P * Math.sqrt(g * g - 1);
                    i = e => {
                        let i = Math.exp(-g * P * e),
                            s = Math.min(t * e, 300);
                        return a - i * ((v + g * P * y) * Math.sinh(s) + t * y * Math.cosh(s)) / t
                    }
                }
                let T = {
                    ...
                    toString: () => {
                        let t = Math.min(c(T), 2e4),
                            e = x(e => T.next(t * e).value, t, 30);
                        return t + "ms " + e
                    }
                };
                return T
            ...
            let eQ = td(.42, 0, 1, 1),
                ...
                e2 = t => {
                    ...
                    return "string" == typeof t ? (F(void 0 !== e5[t], `Invalid easing type '${t}'`), e5[t]) : t
                };
            ...
            function e3({
                ...
                let n = e1(s) ? s.map(e2) : e2(s),
                    ...
                    o = function(t, e, {
                        ...
                        let r = t.length;
                        if (F(r === e.length, "Both input and output ranges must be the same length"), 1 === r) return () => e[0];
                        ...
                        let a = function(t, e, i) {
                                ...
                                for (let i = 0; i < r; i++) {
                                    let r = n(t[i], t[i + 1]);
                                    e && (r = eB(Array.isArray(e) ? e[i] || F : e, r)), s.push(r)
                                }
                                return s
                            }(e, s, n),
                            l = a.length,
            ...
            class e7 extends eA {
                constructor(t) {
                    ...
                    let {
                        ...
                        element: s,
                        keyframes: n
                    } = this.options, r = (null == s ? void 0 : s.KeyframeResolver) || eh;
                ...
                initPlayback(t) {
                    ...
                    let {
                        ...
                        repeatType: o,
                        velocity: a = 0
                    } = this.options, l = p(s) ? s : e6[s] || e3;
                    l !== e3 && "number" != typeof t[0] && (e = eB(e4, ez(t[0], t[1])), t = [0, 100]);
                ...
                onPostResolved() {
                    ...
                    eE.mainThread++, this.play(), "paused" !== this.pendingPlayState && t ? this.state = this.pendingPlayState : this.pause()
                }
                tick(t, e = !1) {
                    let {
                        resolved: i
                    ...
                    if (c) {
                        let t = Math.min(this.currentTime, u) / h,
                            e = Math.floor(t),
                            i = t % 1;
                        !i && t >= 1 && (i = 1), 1 === i && e--, (e = Math.min(e, c + 1)) % 2 && ("reverse" === p ? (i = 1 - i, m && (i -= m / h)) : "mirror" === p && (x = r)), y = tT(0, 1, i) * h
                    }
                    let P = g ? {
                        done: !1,
                        value: a[0]
                    ...
                    return T && void 0 !== s && (P.value = eS(a, this.options, s)), f && f(P.value), T && this.finish(), P
                }
                get duration() {
                    let {
                        resolved: t
                ...
                set time(t) {
                    t = L(t), this.currentTime = t, null !== this.holdTime || 0 === this.speed ? this.holdTime = t : this.driver && (this.startTime = this.driver.now() - t / this.speed)
                }
                get speed() {
            ...
            class ii extends eA {
                constructor(t) {
                    ...
                    this.resolver = new ew(n, (t, e) => this.onKeyframesResolved(t, e), e, i, s), this.resolver.scheduleResolve()
                }
                initPlayback(t, e) {
                    var i;
                    let {
                    ...
                    if ("string" == typeof r && g() && r in ie && (r = ie[r]), p((i = this.options).type) || "spring" === i.type || ! function t(e) {
                        ...
                        1 === (t = h.keyframes).length && (t[1] = t[0]), s = h.duration, n = h.times, r = h.ease, o = "keyframes"
                    }
                    let h = function(t, e, i, {
                        ...
                        l && (u.offset = l);
                        let h = function t(e, i) {
                            if (e) return "function" == typeof e && g() ? x(e, i) : f(e) ? P(e) : Array.isArray(e) ? e.map(e => t(e, i) || w.easeOut) : w[e]
                        }(a, n);
                        Array.isArray(h) && (u.easing = h), H.value && eE.waapi++;
                        let d = t.animate(u, {
                            delay: s,
                            duration: n,
                ...
                static supports(t) {
                    ...
                    return it() && i && e8.has(i) && !a && !l && !s && "mirror" !== n && 0 !== r && "inertia" !== o
                }
            }
            let is = {
                    type: "spring",
                ...
                il = (t, {
                    keyframes: e
                }) => e.length > 2 ? io : O.has(t) ? t.startsWith("scale") ? ir(e[1]) : is : ia,
                iu = (t, e, i, s = {}, n, r) => o => {
                    let a = d(s, t) || {},
                        l = a.delay || s.delay || 0,
                        {
                    ...
                    ! function({
                        ...
                        ...il(t, c)
                    }), c.duration && (c.duration = L(c.duration)), c.repeatDelay && (c.repeatDelay = L(c.repeatDelay)), void 0 !== c.from && (c.keyframes[0] = c.from);
                    let p = !1;
                    if (!1 !== c.type && (0 !== c.duration || c.repeatDelay) || (c.duration = 0, 0 !== c.delay || (p = !0)), (tu.current || W.skipAnimations) && (p = !0, c.duration = 0, c.delay = 0), p && !r && void 0 !== e.get()) {
                        let t = eS(c.keyframes, a);
                        if (void 0 !== t) return X.update(() => {
                            c.onUpdate(t), c.onComplete()
                        }), new h([])
                    }
                    return !r && ii.supports(c) ? new ii(c) : new e7(c)
                };
            ...
            function ih(t, e, {
                ...
                for (let e in u) {
                    ...
                    to(t, e), s.start(iu(e, s, n, t.shouldReduceMotion && I.has(e) ? {
                        type: !1
                    } : o, t, l));
                    let p = s.animation;
                    p && h.push(p)
            ...
            function id(t, e, i = {}) {
                var s;
                let n = o(t, e, "exit" === i.type ? null === (s = t.presenceContext) || void 0 === s ? void 0 : s.custom : void 0),
                    {
                        transition: r = t.getDefaultTransition() || {}
                    } = n || {};
                i.transitionOverride && (r = i.transitionOverride);
                let a = n ? () => Promise.all(ih(t, n, i)) : () => Promise.resolve(),
                    l = t.variantChildren && t.variantChildren.size ? (s = 0) => {
                        ...
                        return function(t, e, i = 0, s = 0, n = 1, r) {
                            ...
                            return Array.from(t.variantChildren).sort(ic).forEach((t, s) => {
                                t.notify("AnimationStart", e), o.push(id(t, e, { ...r,
                                    delay: i + l(s)
                ...
                constructor(t) {
                    super(t), t.animationState || (t.animationState = function(t) {
                        let e = e => Promise.all(e.map(({
                                ...
                                let s;
                                if (t.notify("AnimationStart", e), Array.isArray(e)) s = Promise.all(e.map(e => id(t, e, i)));
                                else if ("string" == typeof e) s = id(t, e, i);
                                else {
                                    let n = "function" == typeof e ? o(t, e, i.custom) : e;
                                    s = Promise.all(ih(t, n, i))
                                }
                                return s.then(() => {
                            ...
                            r = e => (i, s) => {
                                var n;
                                let r = o(t, s, "exit" === e ? null === (n = t.presenceContext) || void 0 === n ? void 0 : n.custom : void 0);
                                if (r) {
                                    let {
                                        transition: t,
                                        transitionEnd: e,
                        ...
                        function a(a) {
                            ...
                            for (let e = 0; e < iP; e++) {
                                ...
                                !1 === y && (p = e);
                                let x = v === u[o] && v !== l[o] && g;
                                if (x && s && t.manuallyAnimateOnMount && (x = !1), f.protectedKeys = { ...c
                                    }, !f.isActive && null === y || !v && !f.prevProp || n(v) || "boolean" == typeof v) continue;
                                let P = (m = f.prevProp, "string" == typeof v ? v !== m : !!Array.isArray(v) && !ip(v, m)),
                                    w = P || o === a && f.isActive && !x && g || e > p && g,
                                    T = !1,
                                ...
                                let {
                                    ...
                                    w = !0, d.has(e) && (T = !0, d.delete(e)), f.needsAnimating[e] = !0;
                                    let i = t.getValue(e);
                                    i && (i.liveStyle = !1)
                                };
                                for (let t in E) {
                                    let e = S[t],
                                        i = A[t];
                                    if (!c.hasOwnProperty(t))(U(e) && U(i) ? ip(e, i) : e === i) ? void 0 !== e && d.has(t) ? M(t) : f.protectedKeys[t] = !0 : null != e ? M(t) : d.add(t)
                                }
                                f.prevProp = v, f.prevResolvedValues = S, f.isActive && (c = { ...c,
                                    ...S
                            ...
                            let f = !!h.length;
                            return s && (!1 === l.initial || l.initial === l.animate) && !t.manuallyAnimateOnMount && (f = !1), s = !1, f ? e(h) : Promise.resolve()
                        }
                        return {
                            animateChanges: a,
            ...
            let iC = t => e => E(e) && t(e, iV(e));

            function iD(t, e, i, s) {
                return iM(t, e, iC(i), s)
            }
                ...
                constructor(t, e, {
                    ...
                    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                            ...
                            let t = iF(this.lastMoveEventInfo, this.history),
                                ...
                                i = function(t, e) {
                                    return Math.sqrt(iR(t.x, e.x) ** 2 + iR(t.y, e.y) ** 2)
                                }(t.offset, {
                                    x: 0,
                                    y: 0
                                }) >= 3;
                            ...
                            this.lastMoveEvent = t, this.lastMoveEventInfo = iL(e, this.transformPagePoint), X.update(this.updatePoint, !0)
                            ...
                            let r = iF("pointercancel" === t.type ? this.lastMoveEventInfo : iL(e, this.transformPagePoint), this.history);
                    ...
                    let r = iL(iV(t), this.transformPagePoint),
                        {
                            point: o
                        } = r,
                        {
                    ...
                    l && l(t, iF(r, this.history)), this.removeListeners = eB(iD(this.contextWindow, "pointermove", this.handlePointerMove), iD(this.contextWindow, "pointerup", this.handlePointerUp), iD(this.contextWindow, "pointercancel", this.handlePointerUp))
                }
                updateHandlers(t) {
                    this.handlers = t
                }
                ...
                return {
                    ...
                    velocity: function(t, e) {
                        ...
                        let i = t.length - 1,
                            s = null,
                            n = iB(t);
                        for (; i >= 0 && (s = t[i], !(n.timestamp - s.timestamp > L(.1)));) i--;
                        if (!s) return {
                            x: 0,
                            y: 0
                        };
                        let r = j(n.timestamp - s.timestamp);
                        if (0 === r) return {
                            x: 0,
                            y: 0
                        };
            ...
            function iU(t, e, i, s = .5) {
                t.origin = s, t.originPoint = eM(e.min, e.max, t.origin), t.scale = iI(i) / iI(e), t.translate = eM(i.min, i.max, t.origin) - t.originPoint, (t.scale >= .9999 && t.scale <= 1.0001 || isNaN(t.scale)) && (t.scale = 1), (t.translate >= -.01 && t.translate <= .01 || isNaN(t.translate)) && (t.translate = 0)
            }

            function i$(t, e, i, s) {
                iU(t.x, e.x, i.x, s ? s.originX : void 0), iU(t.y, e.y, i.y, s ? s.originY : void 0)
            }
            ...
            function i5(t) {
                return i1(t) || i2(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
            }
            ...
            function i3(t, e, i, s, n) {
                return void 0 !== n && (t = s + n * (t - s)), s + i * (t - s) + e
            }

            function i9(t, e = 0, i = 1, s, n) {
                t.min = i3(t.min, e, i, s, n), t.max = i3(t.max, e, i, s, n)
            }
            ...
            function i6(t, {
                ...
                i9(t.x, e.translate, e.scale, e.originPoint), i9(t.y, i.translate, i.scale, i.originPoint)
            }
            ...
            function i7(t, e, i, s, n = .5) {
                let r = eM(t.min, t.max, n);
                i9(t, e, i, r, s)
            }

            function i8(t, e) {
                i7(t.x, e.x, e.scaleX, e.scale, e.originX), i7(t.y, e.y, e.scaleY, e.scale, e.originY)
            }
            ...
            class ss {
                ...
                start(t, {
                    ...
                    this.panSession = new ik(t, {
                        ...
                        onStart: (t, e) => {
                            ...
                            if (i && !s && (this.openDragLock && this.openDragLock(), this.openDragLock = "x" === i || "y" === i ? T[i] ? null : (T[i] = !0, () => {
                                    T[i] = !1
                                }) : T.x || T.y ? null : (T.x = T.y = !0, () => {
                                    T.x = T.y = !1
                                }), !this.openDragLock)) return;
                            this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), iQ(t => {
                                ...
                                if (tO.test(e)) {
                                    ...
                                    if (i && i.layout) {
                                        ...
                                        s && (e = iI(s) * (parseFloat(e) / 100))
                                    }
                                }
                                this.originPoint[t] = e
                            }), n && X.postRender(() => n(t, e)), to(this.visualElement, "transform");
                            let {
                                animationState: r
                            } = this.visualElement;
                ...
                updateAxis(t, e, i) {
                    ...
                    this.constraints && this.constraints[t] && (r = function(t, {
                        ...
                        return void 0 !== e && t < e ? t = s ? eM(e, t, s.min) : Math.max(t, e) : void 0 !== i && t > i && (t = s ? eM(i, t, s.max) : Math.min(t, i)), t
                ...
                resolveConstraints() {
                    ...
                    e && iO(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && s ? this.constraints = function(t, {
                        top: e,
                        left: i,
                        bottom: s,
                        right: n
                    ...
                    }(i), n !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && iQ(t => {
                ...
                resolveRefConstraints() {
                    ...
                    if (!e || !iO(e)) return !1;
                    let s = e.current;
                    F(null !== s, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
                    let {
                        projection: n
                    } = this.visualElement;
                    ...
                    let r = function(t, e, i) {
                            ...
                            return n && (i4(s.x, n.offset.x), i4(s.y, n.offset.y)), s
                        }(s, n.root, this.visualElement.getTransformPagePoint()),
                        o = {
                            x: iY((t = n.layout.layoutBox).x, r.x),
                            y: iY(t.y, r.y)
                        };
                    if (i) {
                        let t = i(function({
                        ...
                        this.hasMutatedConstraints = !!t, t && (o = iJ(t))
                    }
                    return o
                }
                startAnimation(t) {
                ...
                startAxisValueAnimation(t, e) {
                    ...
                    return to(this.visualElement, t), i.start(iu(t, i, 0, e, this.visualElement, !1))
                }
                stopAnimation() {
                ...
                scalePositionWithinConstraints() {
                        ...
                        if (e && !1 !== this.constraints) {
                            ...
                            s[t] = function(t, e) {
                                let i = .5,
                                    s = iI(t),
                                    n = iI(e);
                                return n > s ? i = y(e.min, e.max - s, t.min) : s > n && (i = y(t.min, t.max - n, e.min)), tT(0, 1, i)
                            }({
                                min: i,
                                max: i
                            }, this.constraints[t])
                    ...
                    this.visualElement.current.style.transform = n ? n({}, "") : "none", i.root && i.root.updateScroll(), i.updateLayout(), this.resolveConstraints(), iQ(e => {
            ...
            class sr extends ib {
                constructor(t) {
                    super(t), this.removeGroupControls = F, this.removeListeners = F, this.controls = new ss(t)
                }
                mount() {
                    let {
                        dragControls: t
            ...
            class sa extends ib {
                ...
                createPanHandlers() {
                    ...
                    return {
                        ...
                        onMove: i,
                        onEnd: (t, e) => {
                            delete this.session, s && X.postRender(() => s(t, e))
                        }
                    }
                }
                mount() {
            ...
            class sw extends sd.Component {
                componentDidMount() {
                    ...
                    ! function(t) {
                        for (let e in t) sy[e] = t[e], ep(e) && (sy[e].isCSSVariable = !0)
                    }(sb), n && (e.group && e.group.add(n), i && i.register && s && i.register(n), n.root.didUpdate(), n.addEventListener("animationComplete", () => {
                        this.safeToRemove()
                ...
                getSnapshotBeforeUpdate(t) {
                    ...
                    return r && (r.isPresent = n, s || t.layoutDependency !== e || void 0 === e ? r.willUpdate() : this.safeToRemove(), t.isPresent === n || (n ? r.promote() : r.relegate() || X.postRender(() => {
                        let t = r.getStack();
                ...
                componentDidUpdate() {
                    ...
                    t && (t.root.didUpdate(), sx.postRender(() => {
            ...
            function sT(t) {
                let [e, i] = (0, sc.xQ)(), s = (0, sd.useContext)(sp.L);
                return (0, sh.jsx)(sw, { ...t,
                    layoutGroup: s,
            ...
            let sM = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
                ...
                sD = t => "number" == typeof t || tI.test(t);
            ...
            function sU(t, e, [i, s, n], r, o) {
                ! function(t, e = 0, i = 1, s = .5, n, r = t, o = t) {
                    if (tO.test(e) && (e = parseFloat(e), e = eM(o.min, o.max, e / 100) - o.min), "number" != typeof e) return;
                    let a = eM(r.min, r.max, s);
                    t === r && (a -= e), t.min = sI(t.min, e, i, a, n), t.max = sI(t.max, e, i, a, n)
            ...
            function sW(t, e, i, s) {
                sU(t.x, e, s$, i ? i.x : void 0, s ? s.x : void 0), sU(t.y, e, sN, i ? i.y : void 0, s ? s.y : void 0)
            }
            ...
            class s_ {
                ...
                remove(t) {
                    if (J(this.members, t), t === this.prevLead && (this.prevLead = void 0), t === this.lead) {
                ...
                return class {
                    constructor(t = {}, i = null == e ? void 0 : e()) {
                        this.id = s0++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                            ...
                            this.projectionUpdateScheduled = !1, H.value && (sZ.nodes = sZ.calculatedTargetDeltas = sZ.calculatedProjections = 0), this.nodes.forEach(s9), this.nodes.forEach(ni), this.nodes.forEach(ns), this.nodes.forEach(s6), H.addProjectionMetrics && H.addProjectionMetrics(sZ)
                    ...
                    addEventListener(t, e) {
                        return this.eventHandlers.has(t) || this.eventHandlers.set(t, new tt), this.eventHandlers.get(t).add(e)
                    }
                    notifyListeners(t, ...e) {
                    ...
                    mount(e, i = this.root.hasTreeAnimated) {
                        ...
                        if (r && !r.current && r.mount(e), this.root.nodes.add(this), this.parent && this.parent.children.add(this), i && (n || s) && (this.isLayoutDirty = !0), t) {
                            ...
                            t(e, () => {
                                this.root.updateBlockedByResize = !0, i && i(), i = function(t, e) {
                                    ...
                                    return X.read(s, !0), () => K(s)
                                }(s, 250), sf.hasAnimatedSinceResize && (sf.hasAnimatedSinceResize = !1, this.nodes.forEach(ne))
                            })
                        }
                        s && this.root.registerSharedNode(s, this), !1 !== this.options.animate && r && (s || n) && this.addEventListener("didUpdate", ({
                            ...
                            let n = this.options.transition || r.getDefaultTransition() || nu,
                                {
                    ...
                    unmount() {
                        ...
                        let t = this.getStack();
                        t && t.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, K(this.updateProjection)
                    }
                    blockUpdate() {
                    ...
                    startUpdate() {
                        !this.isUpdateBlocked() && (this.isUpdating = !0, this.nodes && this.nodes.forEach(nn), this.animationId++)
                    }
                    ...
                    willUpdate(t = !0) {
                        ...
                        if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && function t(e) {
                                ...
                                if (window.MotionHasOptimisedAnimation(s, "transform")) {
                                    ...
                                    window.MotionCancelOptimisedAnimation(s, "transform", X, !(t || i))
                                }
                                let {
                                    parent: n
                                } = e;
                    ...
                    update() {
                        if (this.updateScheduled = !1, this.isUpdateBlocked()) {
                            this.unblockUpdate(), this.clearAllSnapshots(), this.nodes.forEach(s7);
                            return
                        }
                        this.isUpdating || this.nodes.forEach(s8), this.isUpdating = !1, this.nodes.forEach(nt), this.nodes.forEach(s2), this.nodes.forEach(s3), this.clearAllSnapshots();
                        let t = Z.now();
                        q.delta = tT(0, 1e3 / 60, t - q.timestamp), q.timestamp = t, q.isProcessing = !0, G.update.process(q), G.preRender.process(q), G.render.process(q), q.isProcessing = !1
                    }
                    didUpdate() {
                        this.updateScheduled || (this.updateScheduled = !0, sx.read(this.scheduleUpdate))
                    }
                    clearAllSnapshots() {
                        this.nodes.forEach(s4), this.sharedNodes.forEach(nr)
                    }
                    ...
                    updateSnapshot() {
                        this.snapshot || !this.instance || (this.snapshot = this.measure(), !this.snapshot || iI(this.snapshot.measuredBox.x) || iI(this.snapshot.measuredBox.y) || (this.snapshot = void 0))
                    }
                    updateLayout() {
                    ...
                    resetTransform() {
                        ...
                        t && (e || i5(this.latestValues) || r) && (n(this.instance, s), this.shouldResetTransform = !1, this.scheduleRender())
                    }
                    measure(t = !0) {
                        var e;
                        let i = this.measurePageBox(),
                            s = this.removeElementScroll(i);
                        return t && (s = this.removeTransform(s)), nc((e = s).x), nc(e.y), {
                            animationId: this.root.animationId,
                            measuredBox: i,
                            layoutBox: s,
                            latestValues: {},
                    ...
                    measurePageBox() {
                        ...
                        if (!((null === (t = this.scroll) || void 0 === t ? void 0 : t.wasRoot) || this.path.some(nm))) {
                            let {
                                scroll: t
                            } = this.root;
                    ...
                    removeElementScroll(t) {
                        var e;
                        let i = iZ();
                        if (sB(i, t), null === (e = this.scroll) || void 0 === e ? void 0 : e.wasRoot) return i;
                        for (let e = 0; e < this.path.length; e++) {
                            ...
                            s !== this.root && n && r.layoutScroll && (n.wasRoot && sB(i, t), i4(i.x, n.offset.x), i4(i.y, n.offset.y))
                        }
                        return i
                    }
                    applyTransform(t, e = !1) {
                        ...
                        for (let t = 0; t < this.path.length; t++) {
                            let s = this.path[t];
                            !e && s.options.layoutScroll && s.scroll && s !== s.root && i8(i, {
                                x: -s.scroll.offset.x,
                                y: -s.scroll.offset.y
                            }), i5(s.latestValues) && i8(i, s.latestValues)
                        }
                        return i5(this.latestValues) && i8(i, this.latestValues), i
                    }
                    removeTransform(t) {
                        let e = iZ();
                        sB(e, t);
                        for (let t = 0; t < this.path.length; t++) {
                            ...
                            let s = iZ();
                            sB(s, i.measurePageBox()), sW(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, s)
                        }
                        return i5(this.latestValues) && sW(e, this.latestValues), e
                    }
                    setTargetDelta(t) {
                    ...
                    resolveTargetDelta(t = !1) {
                        ...
                        if (this.layout && (a || l)) {
                            if (this.resolvedRelativeTargetAt = q.timestamp, !this.targetDelta && !this.relativeTarget) {
                                ...
                                t && t.layout && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = iZ(), this.relativeTargetOrigin = iZ(), iz(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), sB(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                            }
                            if (this.relativeTarget || this.targetDelta) {
                                if ((this.target || (this.target = iZ(), this.targetWithTransforms = iZ()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) ? (this.forceRelativeParentToResolveTarget(), i = this.target, s = this.relativeTarget, n = this.relativeParent.target, iN(i.x, s.x, n.x), iN(i.y, s.y, n.y)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : sB(this.target, this.layout.layoutBox), i6(this.target, this.targetDelta)) : sB(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                                    this.attemptToResolveRelativeTarget = !1;
                                    let t = this.getClosestProjectingParent();
                                    t && !!t.resumingFrom == !!this.resumingFrom && !t.options.layoutScroll && t.target && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = iZ(), this.relativeTargetOrigin = iZ(), iz(this.relativeTargetOrigin, this.target, t.target), sB(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                                }
                                H.value && sZ.calculatedTargetDeltas++
                            }
                        }
                    }
                    getClosestProjectingParent() {
                        return !this.parent || i1(this.parent.latestValues) || i2(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
                    }
                    isProjecting() {
                    ...
                    calcProjection() {
                        ...
                        let e = this.getLead(),
                            ...
                            s = !0;
                        if ((this.isProjectionDirty || (null === (t = this.parent) || void 0 === t ? void 0 : t.isProjectionDirty)) && (s = !1), i && (this.isSharedProjectionDirty || this.isTransformDirty) && (s = !1), this.resolvedRelativeTargetAt === q.timestamp && (s = !1), s) return;
                        let {
                            layout: n,
                            layoutId: r
                        } = this.options;
                        ...
                        ! function(t, e, i, s = !1) {
                            ...
                            if (o) {
                                ...
                                for (let a = 0; a < o; a++) {
                                    ...
                                    (!o || !o.props.style || "contents" !== o.props.style.display) && (s && n.options.layoutScroll && n.scroll && n !== n.root && i8(t, {
                                        x: -n.scroll.offset.x,
                                        y: -n.scroll.offset.y
                                    }), r && (e.x *= r.x.scale, e.y *= r.y.scale, i6(t, r)), s && i5(n.latestValues) && i8(t, n.latestValues))
                                }
                    ...
                    setAnimationOrigin(t, e = !1) {
                        ...
                        let a = iZ(),
                            ...
                            d = !!(l && !h && !0 === this.options.crossfade && !this.path.some(nl));
                        this.animationProgress = 0, this.mixTargetDelta = e => {
                            let s = e / 1e3;
                            if (no(o.x, t.x, s), no(o.y, t.y, s), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                                var u, c, p, m;
                                iz(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox), p = this.relativeTarget, m = this.relativeTargetOrigin, na(p.x, m.x, a.x, s), na(p.y, m.y, a.y, s), i && (u = this.relativeTarget, c = i, sY(u.x, c.x) && sY(u.y, c.y)) && (this.isProjectionDirty = !1), i || (i = iZ()), sB(i, this.relativeTarget)
                            }
                            l && (this.animationValues = r, function(t, e, i, s, n, r) {
                                n ? (t.opacity = eM(0, void 0 !== i.opacity ? i.opacity : 1, sk(s)), t.opacityExit = eM(void 0 !== e.opacity ? e.opacity : 1, 0, sL(s))) : r && (t.opacity = eM(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, s));
                                for (let n = 0; n < sV; n++) {
                                    let r = `border${sM[n]}Radius`,
                                        o = sR(e, r),
                                        a = sR(i, r);
                                    (void 0 !== o || void 0 !== a) && (o || (o = 0), a || (a = 0), 0 === o || 0 === a || sD(o) === sD(a) ? (t[r] = Math.max(eM(sC(o), sC(a), s), 0), (tO.test(a) || tO.test(o)) && (t[r] += "%")) : t[r] = a)
                                }(e.rotate || i.rotate) && (t.rotate = eM(e.rotate || 0, i.rotate || 0, s))
                            }(r, n, this.latestValues, s, d, h)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = s
                        }, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0)
                    }
                    startAnimation(t) {
                        this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (K(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = X.update(() => {
                            sf.hasAnimatedSinceResize = !0, eE.layout++, this.currentAnimation = function(t, e, i) {
                                let s = tr(0) ? 0 : tn(0);
                                ...
                                onComplete: () => {
                                    eE.layout--, t.onComplete && t.onComplete(), this.completeAnimation()
                                }
                    ...
                    applyTransformsToTarget() {
                        ...
                        if (e && i && s) {
                            if (this !== t && this.layout && s && np(this.options.animationType, this.layout.layoutBox, s.layoutBox)) {
                                i = this.target || iZ();
                                let e = iI(this.layout.layoutBox.x);
                                i.x.min = t.target.x.min, i.x.max = i.x.min + e;
                                let s = iI(this.layout.layoutBox.y);
                                i.y.min = t.target.y.min, i.y.max = i.y.min + s
                            }
                            sB(e, i), i8(e, n), i$(this.projectionDeltaWithTransform, this.layoutCorrected, e, n)
                        }
                    }
                    registerSharedNode(t, e) {
                        this.sharedNodes.has(t) || this.sharedNodes.set(t, new s_), this.sharedNodes.get(t).add(e);
                    ...
                    resetSkewAndRotation() {
                        ...
                        for (let e = 0; e < sQ.length; e++) s1(`rotate${sQ[e]}`, t, s, this.animationValues), s1(`skew${sQ[e]}`, t, s, this.animationValues);
                    ...
                    getProjectionStyles(t) {
                        ...
                        if (this.needsReset) return this.needsReset = !1, s.opacity = "", s.pointerEvents = sE(null == t ? void 0 : t.pointerEvents) || "", s.transform = n ? n(this.latestValues, "") : "none", s;
                        let r = this.getLead();
                        if (!this.projectionDelta || !this.layout || !r.target) {
                            let e = {};
                            return this.options.layoutId && (e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1, e.pointerEvents = sE(null == t ? void 0 : t.pointerEvents) || ""), this.hasProjected && !i5(this.latestValues) && (e.transform = n ? n({}, "") : "none", this.hasProjected = !1), e
                        }
                    ...
                    resetTree() {
                        ...
                        }), this.root.nodes.forEach(s7), this.root.sharedNodes.clear()
                    }
                }
            }
            ...
            function s3(t) {
                ...
                if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                    ...
                    i$(o, e, i.layoutBox);
                    let a = iG();
                    r ? i$(a, t.applyTransform(s, !0), i.measuredBox) : i$(a, e, i.layoutBox);
                    let l = !sH(o),
                        u = !1;
                    if (!t.resumeFrom) {
                        ...
                        if (s && !s.resumeFrom) {
                            ...
                            if (n && r) {
                                let o = iZ();
                                iz(o, i.layoutBox, n.layoutBox);
                                let a = iZ();
                                iz(a, e, r.layoutBox), sK(o, a) || (u = !0), s.options.layoutRoot && (t.relativeTarget = a, t.relativeTargetOrigin = o, t.relativeParent = s)
                            }
                        }
                    }
            ...
            function s9(t) {
                H.value && sZ.nodes++, t.parent && (t.isProjecting() || (t.isProjectionDirty = t.parent.isProjectionDirty), t.isSharedProjectionDirty || (t.isSharedProjectionDirty = !!(t.isProjectionDirty || t.parent.isProjectionDirty || t.parent.isSharedProjectionDirty)), t.isTransformDirty || (t.isTransformDirty = t.parent.isTransformDirty))
            }
            ...
            let nu = {
                ...
                nh = t => "undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t),
                nd = nh("applewebkit/") && !nh("chrome/") ? Math.round : F;
            ...
            function np(t, e, i) {
                return "position" === t || "preserve-aspect" === t && !(.2 >= Math.abs(sq(e) - sq(i)))
            }
            ...
            class nx extends ib {
                mount() {
                    ...
                    }(t, (t, e) => (ny(this.node, e, "Start"), t => ny(this.node, t, "End"))))
                }
                unmount() {}
            }
            class nP extends ib {
                ...
                mount() {
                    this.unmount = eB(iM(this.node.current, "focus", () => this.onFocus()), iM(this.node.current, "blur", () => this.onBlur()))
                }
                unmount() {}
            }
                ...
                mount() {
                    ...
                    t && (this.unmount = function(t, e, i = {}) {
                        let [s, n, r] = b(t, i), o = t => {
                            ...
                            if (!k(t) || V.has(s)) return;
                            V.add(s);
                            let r = e(s, t),
                                o = (t, e) => {
                                    window.removeEventListener("pointerup", a), window.removeEventListener("pointercancel", l), k(t) && V.has(s) && (V.delete(s), "function" == typeof r && r(t, {
                                        success: e
                                    }))
                                },
                                a = t => {
                                    o(t, i.useGlobalTarget || A(s, t.target))
                                },
                                l = t => {
                                    o(t, !1)
                                };
                        ...
                        return s.forEach(t => {
                            M.has(t.tagName) || -1 !== t.tabIndex || null !== t.getAttribute("tabindex") || (t.tabIndex = 0), (i.useGlobalTarget ? window : t).addEventListener("pointerdown", o, n), t.addEventListener("focus", t => R(t, n), n)
                        }), r
                    }(t, (t, e) => (nw(this.node, e, "Start"), (t, {
                        success: e
                    }) => nw(this.node, t, e ? "End" : "Cancel")), {
                ...
                startObserver() {
                    ...
                    return function(t, e, i) {
                        let s = function({
                            ...
                            let s = nS.get(i),
                                n = JSON.stringify(e);
                            return s[n] || (s[n] = new IntersectionObserver(nE, {
                                root: t,
                                ...e
                            })), s[n]
                        }(e);
                        return nb.set(t, i), s.observe(t), () => {
            ...
            let nC = (0, sd.createContext)({
                strict: !1
            });
            var nD = i(7249);
            let nR = (0, sd.createContext)({});

            function nk(t) {
                return n(t.animate) || ig.some(e => im(t[e]))
            }
            ...
            function nN(t, {
                ...
                return O.has(t) || t.startsWith("origin") || (e || void 0 !== i) && (!!sy[t] || "opacity" === t)
            }
            ...
            function nK(t, e, i) {
                for (let s in e) tr(e[s]) || nN(s, i) || (t[s] = e[s])
            }
            let nq = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);

            function nG(t) {
                return t.startsWith("while") || t.startsWith("drag") && "draggable" !== t || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || nq.has(t)
            }
            let n_ = t => !nG(t);
            try {
                ! function(t) {
            ...
            let nZ = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
            ...
            function n4(t, e, i) {
                ...
                for (let o in n)(tr(n[o]) || e.style && tr(e.style[o]) || nN(o, t) || (null === (s = null == i ? void 0 : i.getValue(o)) || void 0 === s ? void 0 : s.liveStyle) !== void 0) && (r[o] = n[o]);
                return r
            }
            let n7 = {
                useVisualState: n6({
            ...
            let re = new Set(["baseFrequency", "diffuseConstant", "kernelMatrix", "kernelUnitLength", "keySplines", "keyTimes", "limitingConeAngle", "markerHeight", "markerWidth", "numOctaves", "targetX", "targetY", "surfaceScale", "specularConstant", "specularExponent", "stdDeviation", "tableValues", "viewBox", "gradientTransform", "pathLength", "startOffset", "textLength", "lengthAdjust"]);

            function ri(t, e, i, s) {
                for (let i in rt(t, e, void 0, s), e.attrs) t.setAttribute(re.has(i) ? i : ta(i), e.attrs[i])
            }

            function rs(t, e, i) {
                let s = n4(t, e, i);
                for (let i in t)(tr(t[i]) || tr(e[i])) && (s[-1 !== B.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
                return s
            }
            ...
            class rc {
                ...
                constructor({
                    ...
                    } : {}, this.renderState = l, this.parent = t, this.props = e, this.presenceContext = i, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = s, this.options = o, this.blockInitialAnimation = !!n, this.isControllingVariants = nk(e), this.isVariantNode = nL(e), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(t && t.current);
                    let {
                        willChange: h,
                        ...d
                ...
                mount(t) {
                    this.current = t, rh.set(t, this), this.projection && !this.projection.instance && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((t, e) => this.bindToMotionValue(e, t)), ra.r.current || (0, ro.U)(), this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || ra.O.current), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext)
                }
                unmount() {
                    for (let t in this.projection && this.projection.unmount(), K(this.notifyUpdate), K(this.render), this.valueSubscriptions.forEach(t => t()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this), this.events) this.events[t].clear();
                ...
                bindToMotionValue(t, e) {
                    ...
                    let n = e.on("change", e => {
                            this.latestValues[t] = e, this.props.onUpdate && X.preRender(this.notifyUpdate), s && this.projection && (this.projection.isTransformDirty = !0)
                        }),
                ...
                readValue(t, e) {
                    ...
                    return null != s && ("string" == typeof s && (ed(s) || tw(s)) ? s = parseFloat(s) : !ru(s) && tQ.test(e) && (s = t4(t, e)), this.setBaseTarget(t, tr(s) ? s.get() : s)), tr(s) ? s.get() : s
                }
                setBaseTarget(t, e) {
                    this.baseTarget[t] = e
                }
                getBaseTarget(t) {
                    ...
                    if ("string" == typeof s || "object" == typeof s) {
                        let n = r(this.props, s, null === (e = this.presenceContext) || void 0 === e ? void 0 : e.custom);
                        n && (i = n[t])
                    }
                ...
                on(t, e) {
                    return this.events[t] || (this.events[t] = new tt), this.events[t].add(e)
                }
                notify(t, ...e) {
            ...
            class rf extends rp {
                constructor() {
                    super(...arguments), this.type = "svg", this.isSVGTag = !1, this.measureInstanceViewportBox = iZ, this.updateDimensions = () => {
                        this.current && !this.renderState.dimensions && n8(this.current, this.renderState)
                    }
                }
                getBaseTargetFromProps(t, e) {
                    return t[e]
                ...
                readValueFromInstance(t, e) {
                    ...
                    return e = re.has(e) ? e : ta(e), t.getAttribute(e)
                }
                scrapeMotionValuesFromProps(t, e, i) {
                    return rs(t, e, i)
                }
            ...
            let rv = function(t) {
            ...
            }, su = (t, e) => nQ(t) ? new rf(e) : new rm(e, {
                allowProjection: t !== sd.Fragment
            }), function(t, {
                ...
                return function(t) {
                    ...
                    function l(t, e) {
                        var i;
                        let s;
                        let l = { ...(0, sd.useContext)(nD.Q),
                                ...t,
                                layoutId: function(t) {
                                    let {
                                        layoutId: e
                                    } = t, i = (0, sd.useContext)(sp.L).id;
                        ...
                        if (!u && nF.B) {
                            ...
                            s = t.MeasureLayout, h.visualElement = function(t, e, i, s, n) {
                                var r, o;
                                let {
                                    visualElement: a
                                } = (0, sd.useContext)(nR), l = (0, sd.useContext)(nC), u = (0, sd.useContext)(nU.t), h = (0, sd.useContext)(nD.Q).reducedMotion, d = (0, sd.useRef)(null);
                                ...
                                let f = i[tl],
                                    v = (0, sd.useRef)(!!f && !(null === (r = window.MotionHandoffIsComplete) || void 0 === r ? void 0 : r.call(window, f)) && (null === (o = window.MotionHasOptimisedAnimation) || void 0 === o ? void 0 : o.call(window, f)));
                                return (0, n$.E)(() => {
                                    c && (m.current = !0, window.MotionIsMounted = !0, c.updateFeatures(), sx.render(c.render), v.current && c.animationState && c.animationState.animateChanges())
                                }), (0, sd.useEffect)(() => {
                        ...
                        return (0, sh.jsxs)(nR.Provider, {
                            value: h,
                            children: [s && h.visualElement ? (0, sh.jsx)(s, {
                                visualElement: h.visualElement,
                                ...l
                            }) : null, r(a, t, (i = h.visualElement, (0, sd.useCallback)(t => {
                                t && d.onMount && d.onMount(t), i && (t ? i.mount(t) : i.unmount()), e && ("function" == typeof e ? e(t) : iO(e) && (e.current = t))
                            }, [i])), d, u, h.visualElement)]
                        })
                    }
                    s && function(t) {
                        for (let e in t) nO[e] = { ...nO[e],
                            ...t[e]
                        }
                    ...
                    useRender: function(t = !1) {
                        return (e, i, s, {
                            ...
                            let o = (nQ(e) ? function(t, e, i, s) {
                                    let n = (0, sd.useMemo)(() => {
                                        let i = n2();
                                        return n5(i, e, n3(s), t.transformTemplate), { ...i.attrs,
                                            style: { ...i.style
                                            }
                                        }
                                    }, [e]);
                                    ...
                                    let i = {},
                                        s = function(t, e) {
                                            let i = t.style || {},
                                                s = {};
                                            return nK(s, i, t), Object.assign(s, function({
                                                transformTemplate: t
                                            }, e) {
                                                return (0, sd.useMemo)(() => {
                                                    let i = nX();
                                                    return nY(i, e, t), Object.assign({}, i.vars, i.style)
                                                }, [e])
                                            }(t, e)), s
                                        }(t, e);
                                ...
                                a = function(t, e, i) {
                                    let s = {};
                                    for (let n in t)("values" !== n || "object" != typeof t.values) && (n_(n) || !0 === i && nG(n) || !e && !nG(n) || t.draggable && n.startsWith("onDrag")) && (s[n] = t[n]);
                                    return s
                                }(i, "string" == typeof e, t),
                                l = e !== sd.Fragment ? { ...a,
                                    ...o,
                                ...
                                h = (0, sd.useMemo)(() => tr(u) ? u.get() : u, [u]);
                            return (0, sd.createElement)(e, { ...l,
                                children: h
                            })
                        }
                    }(e),
