...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#0c0a09]/95 backdrop-blur-md border-t border-white/10 px-6 py-4 md:py-5 shadow-2xl animate-in slide-in-from-bottom duration-300">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            onClick={accept}
            className="px-6 py-2 bg-brand-gold text-black font-grotesk text-[11px] uppercase tracking-[0.15em] font-semibold hover:bg-white transition-colors"
          >
            Accept All
          </button>
        </div>
